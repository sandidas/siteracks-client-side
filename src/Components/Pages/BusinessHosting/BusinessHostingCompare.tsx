              ...
              <tbody className="border-b text-base bg-gray-50 dark:bg-gray-900 dark:border-gray-700">
                {comparisonData.map((feature) => (
                  <tr key={feature?.title} className="text-text hover:bg-primary hover:text-white  border-b border-slate-300 dark:border-slate-700 w-full group">
                    ...
                    <td className="px-3 py-2 w-2/12">{feature?.bizHostingStatus ? <CheckIcon className="fill-primary h-5 w-5 group-hover:fill-white" /> : <XMarkIcon className="fill-surfaceTwo h-5 w-5 group-hover:fill-white" />}</td>
                    <td className="px-3 py-2 w-2/12">{feature?.sharedHostingStatus ? <CheckIcon className="fill-primary h-5 w-5 group-hover:fill-surface" /> : <XMarkIcon className="fill-surfaceTwo h-5 w-5 group-hover:fill-white" />}</td>
                  </tr>
                ))}
              </tbody>
            </table>
...
export default BusinessHostingCompare;
