...
const CareerOpenPositions = () => {
  return (
    <div className="max-w-screen-2xl mx-auto px-3 md:px-5 text-center space-y-10">
      ...
      <Button component="a" target={"_blank"} href={`${process.env.ASK_ME}/join-siteracks`} size="xl" className="bg-primary shadow-md transition ease-in-out duration-500  group-hover:text-white group-hover:bg-secondary">
        Apply Here
