      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-16 2xl:gap-32">
        ...
        <article className="flex flex-col space-y-8 group items-start">
          ...
          <ColumnTitleAndDesc title="Our Vision">
            <p className="text-text lg:text-lg lg:leading-8">
              We envision leading the digital spectrum and doing away with traditional and outdated concepts, breathing new life into old solutions and services. We come to work every day charged with adrenaline and ready to build new digital solutions that are fresh, impactful, and resonate well
              with the intended audience.
            </p>
            <p className="text-text lg:text-lg lg:leading-8">
              We look forward to creating lasting business relationships and becoming your partner for years to come. With dedicated account managers, responsive customer support, and all hosting services under one roof, we endeavor to make collaborating with us an experience you are more than happy
              with.
            </p>
          </ColumnTitleAndDesc>
        </article>
