      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-10">
        <FeatureCard backgroundSecond customClass="group text-center">
          <div className="space-y-10">
            ...
            <Button size="xl" component="a" href={`${process.env.BILLING_URL}`} className="shadow-md transition ease-in-out duration-500  group-hover:text-white group-hover:bg-secondary">
