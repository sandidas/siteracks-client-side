      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <FeatureCard backgroundSecond>
          <div className="space-y-5">
            ...
            <p className="text-text">There are no minimum payout requirements. We send out monthly payments, Choose from our flexible payment options based on your preferences.</p>
          </div>
          <div className="grow"></div>
          {/* footer */}
        </FeatureCard>
