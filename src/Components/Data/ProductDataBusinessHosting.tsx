...
export const businessHostingData = [
  ...
  {
    _id: 2,
    title: "Enhance Business Hosting",
    slug: "enhanceBusinessHosting",
  ...
  {
    _id: 3,
    title: "GrowBig Business Hosting",
    slug: "growBigBusinessHosting",
  ...
  {
    _id: 4,
    title: "Expand Business Hosting",
    slug: "expandBusinessHosting",
    shortDescription: "Enhance your website's capacity with boosting server resources",
    description: "A",
    featured: false,
    additionalMonth: "+3 months FREE ",
