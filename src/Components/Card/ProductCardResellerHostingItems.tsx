...
const ProductCardResellerHostingItems: FC<IProps> = ({ product, showAllFeature }) => {
  return (
    <>
      {/* items */}
      <div className="space-y-3 xl:space-y-6" id={product?.slug}>
        <div className="space-y-1">
          <div className="pb-5">
            ...
            <ProductCardFeatureItem feature={product?.clientAccount} />
            ...
            <ProductCardFeatureItem feature={product?.freeWhmcs} />
...
export default ProductCardResellerHostingItems;
