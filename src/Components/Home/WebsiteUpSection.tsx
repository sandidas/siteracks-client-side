    ...
    <>
      <section className="py-[8vh]">
        <div className="flex flex-col gap-5 text-center max-w-5xl mx-auto">
          <h2 className="font-poppins text-4xl md:text-5xl text-title md:leading-tight font-bold">Get Your Website Up & Running Quickly</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 py-[5vh]">
          ...
          <div className="bg-surface p-10 rounded-lg">
            <div className="space-y-5">
              ...
              <h2 className="text-text font-bold text-3xl">Hosting Services</h2>
          ...
          <div className="bg-surface p-10 rounded-lg">
            <div className="space-y-5">
              ...
              <h2 className="text-text font-bold text-3xl">WordPress Solutions</h2>
          ...
          <div className="bg-surface p-10 rounded-lg">
            <div className="space-y-5">
              ...
              <h2 className="text-text font-bold text-3xl">Web App Solutions</h2>
          ...
          <div className="bg-surface p-10 rounded-lg">
            <div className="space-y-5">
              ...
              <h2 className="text-text font-bold text-3xl">Security Services</h2>
          ...
          <div className="bg-surface p-10 rounded-lg">
            <div className="space-y-5">
              ...
              <h2 className="text-text font-bold text-3xl">Business Email Services</h2>
          ...
          <div className="bg-surface p-10 rounded-lg">
            <div className="space-y-5">
              ...
              <h2 className="text-text font-bold text-3xl">Domains</h2>
