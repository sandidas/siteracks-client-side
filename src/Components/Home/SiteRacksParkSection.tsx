  ...
  return (
    <section className="py-[8vh]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 py-[5vh]">
          ...
          <div className="shadow-md border border-slate-100 dark:border-slate-700 p-10 rounded-lg">
            <div className="space-y-5">
              <PremiumCloudIcon className="fill-primary w-14 h-14" />
              <h3 className="text-text font-bold text-3xl">Premium Cloud </h3>
          ...
          <div className="shadow-md border border-slate-100 dark:border-slate-700 p-10 rounded-lg">
            <div className="space-y-5">
              ...
              <h3 className="text-text font-bold text-3xl">Latest Technologies</h3>
              <p className="text-text">Enjoy better latency and lesser downtimes while keeping your account and data always secured.</p>
            </div>
          </div>
          ...
          <div className="shadow-md border border-slate-100 dark:border-slate-700 p-10 rounded-lg">
            <div className="space-y-5">
              ...
              <h3 className="text-text font-bold text-3xl">Improved Uptime </h3>
          ...
          <div className="shadow-md border border-slate-100 dark:border-slate-700 p-10 rounded-lg">
            <div className="space-y-5">
              ...
              <h3 className="text-text font-bold text-3xl">Ultrafast Optimized Server</h3>
          ...
          <div className="shadow-md border border-slate-100 dark:border-slate-700 p-10 rounded-lg">
            <div className="space-y-5">
              ...
              <h3 className="text-text font-bold text-3xl">Quick and Easy Setup</h3>
          ...
          <div className="shadow-md border border-slate-100 dark:border-slate-700 p-10 rounded-lg">
            <div className="space-y-5">
              ...
              <h3 className="text-text font-bold text-3xl">Next-Gen Security</h3>
          ...
          <div className="shadow-md border border-slate-100 dark:border-slate-700 p-10 rounded-lg">
            <div className="space-y-5">
              ...
              <h3 className="text-text font-bold text-3xl">Regular Backups</h3>
          ...
          <div className="shadow-md border border-slate-100 dark:border-slate-700 p-10 rounded-lg">
            <div className="space-y-5">
              ...
              <h3 className="text-text font-bold text-3xl">Free Site Migration</h3>
          ...
          <div className="shadow-md border border-slate-100 dark:border-slate-700 p-10 rounded-lg">
            <div className="space-y-5">
              ...
              <h3 className="text-text font-bold text-3xl">The Clock Support</h3>
