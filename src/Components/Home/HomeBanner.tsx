...
const HomeBanner: FC<IProps> = ({ products, isLoading }) => {
  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-5 grid grid-cols-1 xl:grid-cols-12 xl:gap-5">
      {/* left column  */}
      <div className="xl:col-span-7 flex flex-col items-center xl:items-start group max-w-4xl gap-8 xl:gap-3 pb-[10vh] xl:py-[7vh] mx-auto min-h-screen xl:min-h-fit justify-center">
        ...
        <ul className="text-text gap-2 flex flex-wrap flex-col items-center xl:items-start text-center xl:text-left ">
          <li className="bg-lime-500/20 dark:bg-lime-500/70 text-title px-2 py-1 lg:px-5 lg:font-bold rounded shadow hover:translate-x-2 duration-200 text-sm xl:text-base">Free & Easy Website Migration</li>
          <li className="bg-green-500/10 dark:bg-green-500/70  text-title px-2 py-1 lg:px-5 lg:font-bold rounded shadow hover:translate-x-2 duration-200 text-sm xl:text-base">24/7 priority support</li>
          <li className="bg-violet-500/20 dark:bg-violet-500/70  text-title px-2 py-1 lg:px-5 lg:font-bold rounded shadow hover:translate-x-2 duration-200  text-sm xl:text-base">Free-.com domain, SSL, Email, and Backups</li>
          ...
          <li className="bg-blue-500/20 dark:bg-blue-500/70  text-title px-2 py-1 lg:px-5 lg:font-bold rounded shadow hover:translate-x-2 duration-200  text-sm xl:text-base">30-day of money back guarantee</li>
        </ul>
